...
const BASE_API = "http://localhost:707";
// buat constant untuk menyimpan url server untuk image
const BASE_API_IMAGE = "http://localhost:707/image";
...
// export constant
export { BASE_API, BASE_API_IMAGE, LOCAL_STORAGE_TOKEN, LOCAL_STORAGE_USER, TOKEN };
